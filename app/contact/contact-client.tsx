...
export default function ContactPage() {
  ...
  const [concern, setConcern] = useState("General Skin Care");
            ...
            >
              ...
              <form className="space-y-4" onSubmit={handleSubmit}>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="w-full px-8 py-4 rounded-lg bg-gradient-warm text-white font-bold shadow-lg hover:shadow-xl transition disabled:opacity-70"
                >
