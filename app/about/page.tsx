...
const expertise = [
  ...
  { title: "1000+", description: "Satisfied patients transformed" },
          ...
          >
            ...
            >
              <div>
                ...
                >
                  Board-certified dermatologist dedicated to transforming skin and hair with advanced technology, compassionate care, and proven results in Coimbatore.
                </motion.p>
              </div>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">Premium clinic in Tamil Nadu</p>
                  </div>
                </div>
              </motion.div>
            </motion.div>
