...
const highlights = [
  { count: "500+", label: "Happy Patients", icon: Users },
  { count: "10+", label: "Years Experience", icon: Award },
...
const whyChoose = [
  ...
  "8+ years of experience in dermatology and cosmetic procedures",
...
function AnimatedCard({ children, className = "" }: any) {
          ...
          <div className="page-shell w-full">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                >
                  Award-winning dermatology clinic in Coimbatore offering advanced skin and hair treatments with a personal touch. Dr Divya brings 10+ years of expertise to every consultation.
                </motion.p>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600">500+ Success Stories</p>
                    </div>
                  </div>
                </motion.div>
              </motion.div>
        ...
        <section className="py-20">
          <div className="page-shell">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              {treatments.map(({ title, description, icon: Icon }, idx) => (
                <motion.div
                  key={title}
              ...
              >
                <div>
                  ...
                  <p className="text-lg text-slate-700">
                    Experience premium dermatology care that combines clinical excellence with personalized attention.
                  </p>
                </div>
